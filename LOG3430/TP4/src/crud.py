...
class CRUD:
    ...
    def __init__(self, users_data=None, groups_data=None):
        ...
        try:
            self.users_data = users_data or self.read_users_file()
        except OSError:
            self.users_data = {}

        try:
            self.groups_data = groups_data or self.read_groups_file()
        except OSError:
            self.groups_data = {}
    ...
    def add_new_user(self, user_email, date):
        ...
        # Success
        return self.users_data if self.modify_users_file(self.users_data) else False
    ...
    def add_new_group(self, name, trust, members_list):
        ...
        # Success
        return self.groups_data if self.modify_groups_file(self.groups_data) else False
