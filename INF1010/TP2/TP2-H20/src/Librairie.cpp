...
//! Méthode qui retire un film à la liste des films grace a une surcharge de l operateur -=
...
Librairie& Librairie ::operator-=(std::string film)
{
    ...
    return *this;                                                          // utilisation du mot cle *this; on retourne la valeur pointé dans la librairie
}

//! Méthode qui ajoute un film de la liste grace a une surcharge de l operateur +=
...
//! Méthode qui ecrase les film par la liste des films qui est passee en parametre. 
...
//! Méthode qui affiche la liste des films grace a une surcharge de l operateur <<.
//! \param stream Le stream dans lequel afficché et la liste des films a afficher
//  retourne le stream.
