...
// les #if true � des #if false, et mettre en commentaire tout le code qui a �t�
// �crit pour vous. Ainsi, vous pourrez graduellement les #if true et tester des
// petits blocs de code � la fois. Commencez par �crire vos constructeurs!
...
int main()
{
    ...
    // Vous devez au moins faire le squelette de leurs d�fintions
    ...
    // Assurez-vous de mettre les fichiers � la bonne place pour que
    ...
    // On supprime tous les films ajout�s au test 8
