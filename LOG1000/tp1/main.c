 ...
 * return : Error if the program worked allright, or the error code : 1 means not enought arguments were given. 2 means that the value to root is invalid. 3 means that the number of iterations is invalid.
 * Un bon programeur n'a pas besoin de commentaires
...
int main(int argc, char** argv) {
	...
	float comp = comparison(value_to_root, root);
	printf("Rapport de comparaison: %f\n", comp);
